...
[^3]: See our work on [France](france.pdf), [Britain](britain.pdf) and [Ireland](ireland.pdf)

[^4]: This analysis relies on the assumption that age groups within a census may be treated as a synthetic cohort. An ideal method would track cohorts across time.


[^5]: Tabutin (1978) finds that there was excess female mortality in France during the period, but mainly in late-childhood, rather than infancy.
